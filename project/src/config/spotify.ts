...
export const SPOTIFY_CLIENT_ID = import.meta.env.VITE_SPOTIFY_CLIENT_ID ?? '24df0f6abea64b2c8671922b0489324a';
export const REDIRECT_URI = import.meta.env.VITE_REDIRECT_URI ?? 'https://lighthearted-alfajores-1e4fa2.netlify.app/callback';
